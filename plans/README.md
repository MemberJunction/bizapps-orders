...
| [`payment-schedules-and-percent-complete-revrec.md`](payment-schedules-and-percent-complete-revrec.md) | **Proposal, not started (D85–D90):** `OrderHeaderPaymentSchedule` for instalment billing, the AR-arises-on-invoicing change it depends on, and percentage-of-completion revenue recognition. Raised by the AIDP-Next conversion thread. |
