...
| [`checkout-url-and-openapp-server-extensions.md`](checkout-url-and-openapp-server-extensions.md) | In-flight: public `GET /checkout/:slug` + MJ auto-load of Open App `serverExtensions` |
