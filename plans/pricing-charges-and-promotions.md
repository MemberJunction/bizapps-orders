...
> **Status:** Requirements and approach for review (2026-07-26). Nothing built.
...
| **3** | `OrderCharge` + allocation + shipping + override trail + GL | real order totals |
| **4** | tax as charges + nexus + product-scoped exemptions + provider seam | launch-with-tax |
