...
- [ ] **Step 4: Upstream asks** filed as issues on `MemberJunction/Integrations`: U1 archive verb (only if spike S1 failed), U2 watermark filter. Link them from the spike results doc.
