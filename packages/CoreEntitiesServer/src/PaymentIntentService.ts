...
async function findByProviderIntentID(
    ...
    // different claims, and only one of them is being made here. `EscapeSQLString` rather than an
    // inline replace: it also strips null bytes, which end a quoted literal early.
