...
export class mjBizAppsOrdersSalesAuthorityFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            { sectionKey: 'authorityAssignment', sectionName: 'Authority Assignment', isExpanded: true },
            { sectionKey: 'authorityLimits', sectionName: 'Authority Limits', isExpanded: true },
            { sectionKey: 'scopeAndPermissions', sectionName: 'Scope and Permissions', isExpanded: true },
