...
export class mjBizAppsOrdersOrderLineFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'productAndFulfillment', sectionName: 'Product and Fulfillment', isExpanded: true },
            { sectionKey: 'orderLineDetails', sectionName: 'Order Line Details', isExpanded: true },
            { sectionKey: 'pricingAndAmounts', sectionName: 'Pricing and Amounts', isExpanded: true },
