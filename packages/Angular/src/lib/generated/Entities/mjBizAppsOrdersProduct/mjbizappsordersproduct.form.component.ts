...
export class mjBizAppsOrdersProductFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'financialAndLifecycle', sectionName: 'Financial and Lifecycle', isExpanded: true },
            { sectionKey: 'productEvolution', sectionName: 'Product Evolution', isExpanded: true },
            { sectionKey: 'taxation', sectionName: 'Taxation', isExpanded: true },
