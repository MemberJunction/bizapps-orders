...
export class mjBizAppsOrdersOrderAdjustmentFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'promotionAndDiscount', sectionName: 'Promotion and Discount', isExpanded: true },
            { sectionKey: 'pricingAndAdjustment', sectionName: 'Pricing and Adjustment', isExpanded: true },
