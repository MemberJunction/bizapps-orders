...
-- Two Sequence edits by hand: the fields added to EXISTING entities are sequenced
-- `MAX(Sequence) + 1` (the IsOverdue precedent, V202608131542) instead of a literal
-- that collides with UQ_EntityField_EntityID_Sequence on any database whose field
-- list differs, and CodeGen's `+100000` bump blocks are removed since nothing here
-- inserts a literal that could collide.
-- =============================================================================
